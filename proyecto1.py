# print("Hola " +input("Cual es tu nombre y apellido?: " + " " + "Con base en tus respuestas,\nel nombre de tu cerveza seria: " + " input("Dime que color es el que mas te gusta?: ")
# input("Cual es la temporada del año que mas te gusta?: ")
# input("Dime tu super poder favorito: ")
#
